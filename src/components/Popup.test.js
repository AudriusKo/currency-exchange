...
describe('<Popup />', () => {
  ...
  it('should render all currencies in the wallet', () => {
    ...
    expect(wrapper.find(CurrencyItem)).toHaveLength(Object.keys(props.wallets).length)
  });
  ...
  it('should not set currency when selecting already selected currency', () => {
    ...
    wrapper.find(CurrencyItem).at(0).simulate('click')
  ...
  it('should set currency', () => {
    ...
    wrapper.find(CurrencyItem).at(2).simulate('click')
  ...
  it('should swap currencies', () => {
    ...
    wrapper.find(CurrencyItem).at(1).simulate('click')
